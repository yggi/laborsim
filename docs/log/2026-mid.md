...
The diegetic frame went to `docs/design/rig/training-frame.md`, which also settled
...
The experiment itself is **pre-registered** in `docs/design/cab/theming.md` — the
...
**Crystallized from a design dump** (`docs/design/cab/cockpit.md`, `damage.md`):
...
**Panel rendering, discussed and settled** — `docs/design/cab/instrument-rendering.md`.
...
**The critical-path review** — `docs/design/code/roadmap.md`. Four findings drove the
reordering:
