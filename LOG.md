...
- `docs/log/2026-voice.md` — the voice: a horn that is a horn, a panel that
  clicks, sound becoming part of what a manufacturer *is*, and the pod joining
  the registry — the session that moved the cockpit/ui seam.
