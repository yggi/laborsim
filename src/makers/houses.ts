 ...
 * (`doc/design/rig/tone.md`). A manufacturer sells and warns, and this is the first
 ...
 * doc/design/cab/instrument-rendering.md for why the panels are DOM at all.
 */
...
const MAKERS: Record<string, MakerStyle> = {
  ...
  // exists to claim it (doc/design/cab/components.md).
  "KIBA WORKS": {
    wordmark: "KIBA WORKS",
    plate: "#2b2a20",
    bezel: "#0d1012",
