 ...
 * (`doc/design/cab/components.md`). They were not written that way: cells were
 ...
 * (glass, rack, dash) is one front too many (`doc/design/cab/components.md`).
 *
 ...
 * costs is view (`doc/design/cab/cockpit.md`).
 *
