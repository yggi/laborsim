...
Crystallized facts live in `doc/MEMORY.md`; this is the connective tissue around
...
transfers. This is the frame in `doc/MEMORY.md` § 1.1, told as a story.
...
house voice (`doc/design/rig/tone.md`): condescending institutional politeness, the
...
the thing still working (`doc/MEMORY.md` § 5).
...
on the "nothing else" (`doc/design/machine/arbitration.md`).

**How its kit fails:** it believes what it is told. Every TOWA sensor is a
surface a **Phantom Labor** can attack (`doc/design/rig/mechanics.md`): spoof the
...
(`doc/design/cab/cockpit.md`). It is usually right. It is right in a manner
...
*reverse* the thing it governs (`doc/LOG.md`, 2026-08-24).
...
- **The Phantom Labor's origin.** The antagonist that attacks TOWA's sensor
  ...
  wearing a mask, not a plot (`doc/design/rig/mechanics.md`).
- **The police / municipal Labor** — the "fancy" chassis opposite the KIBA
  bulldozer, and the first customer for a themed cockpit (`doc/design/cab/cockpit.md`,
