...
`doc/MEMORY.md` was reported as within its 300-line limit at 307. Print the number;
do not estimate it — and print it *before* the commit, not after: a later round
ran `wc` in the same command that committed the trim and shipped `doc/NOTES.md` at
